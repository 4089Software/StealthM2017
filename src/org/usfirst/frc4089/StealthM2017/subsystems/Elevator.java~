...
public class Elevator extends Subsystem {
	...
	private final CANTalon elevatorMotorOne = RobotMap.elevatorMotorOne;
	private final CANTalon elevatorMotorTwo = RobotMap.elevatorMotorTwo;
    ...
    public void lowerElv(){
		elevatorMotorOne.set(-Constants.elevMotorSpdOne);
		elevatorMotorTwo.set(Constants.elevMotorSpdTwo);
	}
