...
public class RobotMap {
    ...
    public static SpeedController driveMotorD1;
    public static SpeedController driveMotorD2;
    public static SpeedController driveMotorD3;
    public static SpeedController driveMotorD4;
    public static RobotDrive driveRobotDrive41;
    public static SpeedController ballCollectorMotorBC;
    public static SpeedController shooterMotorShoot;
    public static Encoder shooterEncoderShoot;
    public static SpeedController elevatorMotorElev;
    ...
    public static void init() {
        ...
        driveMotorD1 = new TalonSRX(3);
        LiveWindow.addActuator("Drive", "MotorD1", (TalonSRX) driveMotorD1);
        
        driveMotorD2 = new TalonSRX(4);
        LiveWindow.addActuator("Drive", "MotorD2", (TalonSRX) driveMotorD2);
        
        driveMotorD3 = new TalonSRX(5);
        LiveWindow.addActuator("Drive", "MotorD3", (TalonSRX) driveMotorD3);
        
        driveMotorD4 = new TalonSRX(6);
        LiveWindow.addActuator("Drive", "MotorD4", (TalonSRX) driveMotorD4);
        ...
        ballCollectorMotorBC = new TalonSRX(0);
        LiveWindow.addActuator("BallCollector", "MotorBC", (TalonSRX) ballCollectorMotorBC);
        
        shooterMotorShoot = new TalonSRX(1);
        LiveWindow.addActuator("Shooter", "MotorShoot", (TalonSRX) shooterMotorShoot);
        ...
        elevatorMotorElev = new TalonSRX(2);
        LiveWindow.addActuator("Elevator", "MotorElev", (TalonSRX) elevatorMotorElev);
